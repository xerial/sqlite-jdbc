...
public abstract class JDBC3Connection extends SQLiteConnection {
     ...
     * <ul><li>If this connection is read only, the PRAGMA query_only will be set</li>
     * <li>If this connection is not read only:</li>
     * <ul>
     * <li>if no statement has been executed, PRAGMA query_only will be set to false, and an IMMEDIATE transaction will be started</li>
     * <li>if a statement has already been executed, an exception is thrown</li>
     * </ul></ul>
     *
     * @throws SQLException if a statement has already been executed on this connection, then the transaction cannot be upgraded to write
     */
    ...
    public void tryEnforceTransactionMode() throws SQLException {
        ...
        if (getDatabase().getConfig().isExplicitReadOnly() && !this.getAutoCommit() && this.getCurrentTransactionMode() != null) {
            if (isReadOnly()) {
                ...
                if (getCurrentTransactionMode() == TransactionMode.DEFERRED || this.getCurrentTransactionMode() == TransactionMode.DEFFERED) {
