...
public abstract class JDBC3Statement extends CoreStatement {
    ...
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        if (autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS && QueryUtils.isInsertQuery(sql)) {
            return executeStatementInsert(sql, "*") != 0 ? true : false;
        }
        return execute(sql);
    }
    ...
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        if (autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS && QueryUtils.isInsertQuery(sql)) {
            return executeStatementInsert(sql, "*");
        }
    ...
    protected int executeStatementInsert(String sql, String keys) throws SQLException {
        updateGeneratedKeys(executeQuery(QueryUtils.addReturningClause(sql, keys)));
        return 1;
    }
    ...
    public boolean execute(String sql, String[] colnames) throws SQLException {
        if (QueryUtils.isInsertQuery(sql)) {
            return executeStatementInsert(sql, String.join(",", colnames)) != 0 ? true : false;
        }
        return false;
    }
    ...
    public int executeUpdate(String sql, String[] colnames) throws SQLException {
        if (QueryUtils.isInsertQuery(sql)) {
            return executeStatementInsert(sql, String.join(",", colnames));
        }
        return 0;
    }
