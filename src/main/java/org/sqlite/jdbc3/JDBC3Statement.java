...
public abstract class JDBC3Statement extends CoreStatement {
    ...
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        if (autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS && isInsertQuery(sql)) {
            return executeInsert(sql, "*") != 0 ? true : false;
        }
        return execute(sql);
    }
    ...
    private int executeInsert(String sql, String keys) throws SQLException {
        ...
        updateGeneratedKeys(executeQuery(sql));
        return 1;
    }
    ...
    public boolean execute(String sql, String[] colnames) throws SQLException {
        if (isInsertQuery(sql)) {
            return executeInsert(sql, String.join(",", colnames)) != 0 ? true : false;
        }
        return false;
    }
    ...
    public int executeUpdate(String sql, String[] colnames) throws SQLException {
        if (isInsertQuery(sql)) {
            return executeInsert(sql, String.join(",", colnames));
        }
        return 0;
    }
