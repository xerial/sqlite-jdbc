...
The bundled native library compiles official SQLite extensions such as FTS5, R*Tree, and JSON in.
See link:USAGE.md#compiled-sqlite-extensions[USAGE.md] for the full list, and for what is not included.
