...
image:https://img.shields.io/maven-central/v/dev.aga.sqlite/sqlite-jdbc?color=g&label=maven%20central[Maven Central,link=https://search.maven.org/search?q=g:%22dev.aga.sqlite%22%20AND%20a:%22sqlite-jdbc%22]
